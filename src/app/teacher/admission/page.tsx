      ...
      <section className="flex flex-col w-2/4 mt-8">
        <div className="flex flex-col items-center mt-6">
          <div className="flex flex-row">
            ...
            <button className="bg-black text-white cursor-pointer hover:underline rounded-md p-2 ml-2">
              Accept
            </button>
            <button className="bg-red-600 text-white cursor-pointer hover:underline rounded-md p-2 ml-2">
              Reject
            </button>
          </div>
